 ...
 */
final class Version20251214133715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE \"user\" SET first_name = '', last_name = '' WHERE first_name IS NULL OR last_name IS NULL");
